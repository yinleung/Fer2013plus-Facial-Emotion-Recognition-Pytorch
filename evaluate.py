...
parser = argparse.ArgumentParser(description='UCAS Affective Computing Final Project')
parser.add_argument('--batch_size', default=128, type=int)
parser.add_argument('--seed', default=0, type=int)
parser.add_argument('--data_path', default='datasets/fer2013/fer2013_new.csv', type=str)
parser.add_argument('--checkpoint', default='results/test2/ResNet18_epoch300_bs128_lr0.1_momentum0.9_wd0.0001_seed0_smoothTrue_mixupTrue_schedulerreduce_test2/checkpoints/best_checkpoint.tar', type=str)
