            ...
            if args.label_smooth:
                if args.mixup:
                    ...
                    soft_labels_a = smooth_one_hot(
                        labels_a, classes=10, smoothing=args.label_smooth_value)
                    soft_labels_b = smooth_one_hot(
                        labels_b, classes=10, smoothing=args.label_smooth_value)
                    loss = mixup_criterion(
                        loss_fn, outputs, soft_labels_a, soft_labels_b, lam)
                else:
                    # label smooth
                    soft_labels = smooth_one_hot(
                        labels, classes=10, smoothing=args.label_smooth_value)
