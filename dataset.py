...
def load_data(path='datasets/fer2013/fer2013_new.csv'):
    fer2013 = pd.read_csv(path)
    emotion_mapping = {0: 'Neutral', 1: 'Happy', 2: 'Surprise', 3: 'Sad', 4: 'Anger', 5: 'Disgust', 6: 'Fear', 7: 'Contempt', 8: 'Unknown', 9: 'NF'}
...
def get_dataloaders(path='datasets/fer2013/fer2013_new.csv', bs=64, augment=True):
